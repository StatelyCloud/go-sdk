...
const file_db_continue_list_proto_rawDesc = "" +
	"\n" +
	"\x16db/continue_list.proto\x12\n" +
	"stately.db\x1a\x1bbuf/validate/validate.proto\"\xce\x01\n" +
	"\x13ContinueListRequest\x12%\n" +
	"\n" +
	"token_data\x18\x01 \x01(\fB\x06\xbaH\x03\xc8\x01\x01R\ttokenData\x12?\n" +
	"\tdirection\x18\x02 \x01(\x0e2!.stately.db.ContinueListDirectionR\tdirection\x122\n" +
	"\x11schema_version_id\x18\x05 \x01(\rB\x06\xbaH\x03\xc8\x01\x01R\x0fschemaVersionId\x12\x1b\n" +
	"\tschema_id\x18\x06 \x01(\x04R\bschemaId*N\n" +
	"\x15ContinueListDirection\x12\x19\n" +
	"\x15CONTINUE_LIST_FORWARD\x10\x00\x12\x1a\n" +
	"\x16CONTINUE_LIST_BACKWARD\x10\x01B\x92\x01\n" +
	"\x0ecom.stately.dbB\x11ContinueListProtoP\x01Z$github.com/StatelyCloud/go-sdk/pb/db\xa2\x02\x03SDX\xaa\x02\n" +
	"Stately.Db\xca\x02\n" +
...
var (
	...
	file_db_continue_list_proto_rawDescData []byte
)

func file_db_continue_list_proto_rawDescGZIP() []byte {
	file_db_continue_list_proto_rawDescOnce.Do(func() {
		file_db_continue_list_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_db_continue_list_proto_rawDesc), len(file_db_continue_list_proto_rawDesc)))
	})
...
var file_db_continue_list_proto_goTypes = []any{
...
func file_db_continue_list_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_db_continue_list_proto_rawDesc), len(file_db_continue_list_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
