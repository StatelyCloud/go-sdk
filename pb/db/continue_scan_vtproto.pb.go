...
func (m *ContinueScanRequest) CloneVT() *ContinueScanRequest {
	if m == nil {
		return (*ContinueScanRequest)(nil)
	}
	r := new(ContinueScanRequest)
...
func (m *ContinueScanRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *ContinueScanRequest) EqualVT(that *ContinueScanRequest) bool {
	if this == that {
		return true
...
func (this *ContinueScanRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ContinueScanRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (m *ContinueScanRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ContinueScanRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ContinueScanRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ContinueScanRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ContinueScanRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ContinueScanRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContinueScanRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
