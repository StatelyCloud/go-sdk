...
const file_db_transaction_proto_rawDesc = "" +
	...
	"stately.db\x1a\x1bbuf/validate/validate.proto\x1a\x16db/continue_list.proto\x1a\x0fdb/delete.proto\x1a\fdb/get.proto\x1a\rdb/item.proto\x1a\rdb/list.proto\x1a\x15db/list_filters.proto\x1a\fdb/put.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xae\x04\n" +
	...
	"\x04gets\x18\x01 \x03(\v2\x13.stately.db.GetItemB\b\xbaH\x05\x92\x01\x02\b\x01R\x04gets\"\xbb\x02\n" +
	...
	"\xbaH\a\x92\x01\x04\b\x00\x10\x02R\rkeyConditionsJ\x04\b\x03\x10\x04\"\x81\x01\n" +
...
var file_db_transaction_proto_goTypes = []any{
	...
	(SortDirection)(0),              // 15: stately.db.SortDirection
	(*FilterCondition)(nil),         // 16: stately.db.FilterCondition
	(*KeyCondition)(nil),            // 17: stately.db.KeyCondition
	(ContinueListDirection)(0),      // 18: stately.db.ContinueListDirection
	(*PutItem)(nil),                 // 19: stately.db.PutItem
	(*DeleteItem)(nil),              // 20: stately.db.DeleteItem
	(*Item)(nil),                    // 21: stately.db.Item
	(*ListPartialResult)(nil),       // 22: stately.db.ListPartialResult
	(*ListFinished)(nil),            // 23: stately.db.ListFinished
	(*DeleteResult)(nil),            // 24: stately.db.DeleteResult
}
var file_db_transaction_proto_depIdxs = []int32{
	...
	15, // 13: stately.db.TransactionBeginList.sort_direction:type_name -> stately.db.SortDirection
	16, // 14: stately.db.TransactionBeginList.filter_conditions:type_name -> stately.db.FilterCondition
	17, // 15: stately.db.TransactionBeginList.key_conditions:type_name -> stately.db.KeyCondition
	18, // 16: stately.db.TransactionContinueList.direction:type_name -> stately.db.ContinueListDirection
	19, // 17: stately.db.TransactionPut.puts:type_name -> stately.db.PutItem
	20, // 18: stately.db.TransactionDelete.deletes:type_name -> stately.db.DeleteItem
	21, // 19: stately.db.TransactionGetResponse.items:type_name -> stately.db.Item
	9,  // 20: stately.db.TransactionPutAck.generated_ids:type_name -> stately.db.GeneratedID
	22, // 21: stately.db.TransactionListResponse.result:type_name -> stately.db.ListPartialResult
	23, // 22: stately.db.TransactionListResponse.finished:type_name -> stately.db.ListFinished
	21, // 23: stately.db.TransactionFinished.put_results:type_name -> stately.db.Item
	24, // 24: stately.db.TransactionFinished.delete_results:type_name -> stately.db.DeleteResult
