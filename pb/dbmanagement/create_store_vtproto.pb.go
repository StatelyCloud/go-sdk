...
func (m *CreateStoreRequest) CloneVT() *CreateStoreRequest {
	if m == nil {
		return (*CreateStoreRequest)(nil)
	}
	r := new(CreateStoreRequest)
...
func (m *CreateStoreResponse) CloneVT() *CreateStoreResponse {
	if m == nil {
		return (*CreateStoreResponse)(nil)
	}
	r := new(CreateStoreResponse)
	r.StoreId = m.StoreId
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (this *CreateStoreRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CreateStoreRequest)
	if !ok {
		return false
	}
...
func (this *CreateStoreResponse) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CreateStoreResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
