...
func (m *DeleteProjectRequest) CloneVT() *DeleteProjectRequest {
	if m == nil {
		return (*DeleteProjectRequest)(nil)
	}
	r := new(DeleteProjectRequest)
...
func (m *DeleteProjectResponse) CloneVT() *DeleteProjectResponse {
	if m == nil {
		return (*DeleteProjectResponse)(nil)
	}
	r := new(DeleteProjectResponse)
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (this *DeleteProjectRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DeleteProjectRequest)
	if !ok {
		return false
	}
...
func (this *DeleteProjectResponse) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DeleteProjectResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
