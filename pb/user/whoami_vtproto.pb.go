...
func (m *WhoamiResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EnrollmentTime != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.EnrollmentTime))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Email) > 0 {
...
func (m *WhoamiResponse) SizeVT() (n int) {
	...
	if m.EnrollmentTime != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.EnrollmentTime))
	}
	l = len(m.DisplayName)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
