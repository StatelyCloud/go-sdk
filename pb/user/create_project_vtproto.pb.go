...
func (m *CreateProjectRequest) CloneVT() *CreateProjectRequest {
	if m == nil {
		return (*CreateProjectRequest)(nil)
	}
	r := new(CreateProjectRequest)
	r.OrganizationId = m.OrganizationId
	r.Name = m.Name
	r.Description = m.Description
	r.CreateSchema = m.CreateSchema
...
func (m *CreateProjectResponse) CloneVT() *CreateProjectResponse {
	if m == nil {
...
func (this *CreateProjectRequest) EqualVT(that *CreateProjectRequest) bool {
	...
	if this.CreateSchema != that.CreateSchema {
		return false
	}
...
func (this *CreateProjectRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CreateProjectRequest)
	if !ok {
		return false
	}
...
func (this *CreateProjectResponse) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CreateProjectResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *CreateProjectRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreateSchema", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
