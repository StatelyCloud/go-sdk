...
func (m *GetResponse) CloneVT() *GetResponse {
	...
	if rhs := m.Results; rhs != nil {
		tmpContainer := make([]*GetItemResult, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *GetItemResult) CloneVT() *GetItemResult {
	if m == nil {
...
func (m *GetItemResult) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *GetItemResult) EqualVT(that *GetItemResult) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *GetItemResult) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*GetItemResult)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *GetItemResult) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *GetItemResult) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *GetItemResult) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *GetItemResult) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Results = append(m.Results, &GetItemResult{})
...
func (m *GetItemResult) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetItemResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetItemResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
