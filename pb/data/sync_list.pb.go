...
func (x *SyncListRequest) Reset() {
	*x = SyncListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_sync_list_proto_msgTypes[0]
...
func (*SyncListRequest) Descriptor() ([]byte, []int) {
	return file_data_sync_list_proto_rawDescGZIP(), []int{0}
}
...
func (x *SyncListResponse) Reset() {
	*x = SyncListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_sync_list_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncListResponse) Descriptor() ([]byte, []int) {
	return file_data_sync_list_proto_rawDescGZIP(), []int{1}
}
...
func (x *SyncListReset) Reset() {
	*x = SyncListReset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_sync_list_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncListReset) Descriptor() ([]byte, []int) {
	return file_data_sync_list_proto_rawDescGZIP(), []int{2}
}
...
func (x *SyncListPartialResponse) Reset() {
	*x = SyncListPartialResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_sync_list_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncListPartialResponse) Descriptor() ([]byte, []int) {
	return file_data_sync_list_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeletedItem) Reset() {
	*x = DeletedItem{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_sync_list_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeletedItem) Descriptor() ([]byte, []int) {
	return file_data_sync_list_proto_rawDescGZIP(), []int{4}
}
...
var file_data_sync_list_proto_rawDesc = []byte{
	,
	...
	0x73, 0x68, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x74, 0x61,
	...
	,
...
var (
	file_data_sync_list_proto_rawDescOnce sync.Once
	file_data_sync_list_proto_rawDescData = file_data_sync_list_proto_rawDesc
)

func file_data_sync_list_proto_rawDescGZIP() []byte {
	file_data_sync_list_proto_rawDescOnce.Do(func() {
		file_data_sync_list_proto_rawDescData = protoimpl.X.CompressGZIP(file_data_sync_list_proto_rawDescData)
	})
	return file_data_sync_list_proto_rawDescData
}

var file_data_sync_list_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_data_sync_list_proto_goTypes = []interface{}{
	(*SyncListRequest)(nil),         // 0: stately.data.SyncListRequest
	(*SyncListResponse)(nil),        // 1: stately.data.SyncListResponse
	(*SyncListReset)(nil),           // 2: stately.data.SyncListReset
	(*SyncListPartialResponse)(nil), // 3: stately.data.SyncListPartialResponse
	(*DeletedItem)(nil),             // 4: stately.data.DeletedItem
	(*ListFinished)(nil),            // 5: stately.data.ListFinished
	(*Item)(nil),                    // 6: stately.data.Item
}
var file_data_sync_list_proto_depIdxs = []int32{
	2, // 0: stately.data.SyncListResponse.reset:type_name -> stately.data.SyncListReset
	3, // 1: stately.data.SyncListResponse.result:type_name -> stately.data.SyncListPartialResponse
	5, // 2: stately.data.SyncListResponse.finished:type_name -> stately.data.ListFinished
	6, // 3: stately.data.SyncListPartialResponse.changed_items:type_name -> stately.data.Item
	4, // 4: stately.data.SyncListPartialResponse.deleted_items:type_name -> stately.data.DeletedItem
...
func init() { file_data_sync_list_proto_init() }
func file_data_sync_list_proto_init() {
	if File_data_sync_list_proto != nil {
		return
	}
	file_data_item_proto_init()
	file_data_list_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_data_sync_list_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_sync_list_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_sync_list_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_sync_list_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_sync_list_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_data_sync_list_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_data_sync_list_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_data_sync_list_proto_goTypes,
		DependencyIndexes: file_data_sync_list_proto_depIdxs,
		MessageInfos:      file_data_sync_list_proto_msgTypes,
	}.Build()
	File_data_sync_list_proto = out.File
	file_data_sync_list_proto_rawDesc = nil
	file_data_sync_list_proto_goTypes = nil
	file_data_sync_list_proto_depIdxs = nil
}
