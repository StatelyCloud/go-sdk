...
func (m *TransactionRequest_AppendItems) CloneVT() isTransactionRequest_Command {
	if m == nil {
		return (*TransactionRequest_AppendItems)(nil)
	}
	r := new(TransactionRequest_AppendItems)
	r.AppendItems = m.AppendItems.CloneVT()
	return r
}
...
func (m *TransactionResponse_AppendAck) CloneVT() isTransactionResponse_Result {
	if m == nil {
		return (*TransactionResponse_AppendAck)(nil)
	}
	r := new(TransactionResponse_AppendAck)
	r.AppendAck = m.AppendAck.CloneVT()
	return r
}
...
func (m *TransactionAppend) CloneVT() *TransactionAppend {
	if m == nil {
		return (*TransactionAppend)(nil)
	}
	r := new(TransactionAppend)
...
func (m *TransactionAppendAck) CloneVT() *TransactionAppendAck {
	if m == nil {
		return (*TransactionAppendAck)(nil)
	}
	r := new(TransactionAppendAck)
	if rhs := m.KeyPaths; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.KeyPaths = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *TransactionFinished) CloneVT() *TransactionFinished {
	...
	if rhs := m.AppendResults; rhs != nil {
		tmpContainer := make([]*AppendItemResult, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.AppendResults = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (this *TransactionRequest_AppendItems) EqualVT(thatIface isTransactionRequest_Command) bool {
	that, ok := thatIface.(*TransactionRequest_AppendItems)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.AppendItems, that.AppendItems; p != q {
		if p == nil {
			p = &TransactionAppend{}
		}
		if q == nil {
...
func (this *TransactionResponse_AppendAck) EqualVT(thatIface isTransactionResponse_Result) bool {
	that, ok := thatIface.(*TransactionResponse_AppendAck)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.AppendAck, that.AppendAck; p != q {
		if p == nil {
			p = &TransactionAppendAck{}
		}
		if q == nil {
			q = &TransactionAppendAck{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (this *TransactionAppend) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TransactionAppend)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *TransactionAppendAck) EqualVT(that *TransactionAppendAck) bool {
	...
	if len(this.KeyPaths) != len(that.KeyPaths) {
		return false
	}
	for i, vx := range this.KeyPaths {
		vy := that.KeyPaths[i]
		if vx != vy {
			return false
		}
...
func (this *TransactionAppendAck) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TransactionAppendAck)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *TransactionFinished) EqualVT(that *TransactionFinished) bool {
	...
	if len(this.AppendResults) != len(that.AppendResults) {
		return false
	}
	for i, vx := range this.AppendResults {
		vy := that.AppendResults[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &AppendItemResult{}
			}
...
func (m *TransactionRequest_AppendItems) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AppendItems != nil {
		size, err := m.AppendItems.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TransactionResponse_AppendAck) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AppendAck != nil {
		size, err := m.AppendAck.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TransactionAppendAck) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.KeyPaths) > 0 {
		for iNdEx := len(m.KeyPaths) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.KeyPaths[iNdEx])
			copy(dAtA[i:], m.KeyPaths[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.KeyPaths[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *TransactionFinished) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AppendResults) > 0 {
		for iNdEx := len(m.AppendResults) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.AppendResults[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TransactionRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppendItems", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Command.(*TransactionRequest_AppendItems); ok {
				if err := oneof.AppendItems.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &TransactionAppend{}
				...
				m.Command = &TransactionRequest_AppendItems{AppendItems: v}
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
...
func (m *TransactionResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppendAck", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Result.(*TransactionResponse_AppendAck); ok {
				if err := oneof.AppendAck.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &TransactionAppendAck{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Result = &TransactionResponse_AppendAck{AppendAck: v}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *TransactionAppend) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransactionAppend: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransactionAppend: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TransactionAppendAck) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransactionAppendAck: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransactionAppendAck: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KeyPaths", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KeyPaths = append(m.KeyPaths, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *TransactionFinished) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PutResults = append(m.PutResults, &PutResult{})
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppendResults", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AppendResults = append(m.AppendResults, &AppendItemResult{})
			if err := m.AppendResults[len(m.AppendResults)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
