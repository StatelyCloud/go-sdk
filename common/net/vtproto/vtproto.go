...
// Not sure where else to put this, but it sets up gRPC to use the vtprotobuf codec that's faster/more memory efficient
...
import (
	...
	// This import is necessary so gRPC installs its default encoding first and then we can replace it.
